...
const YogaPractice = ({ pose, onEndPractice }) => {
  return (
    <div className="min-h-screen bg-gray-100 p-8 flex flex-col items-center">
      <div className="flex justify-between items-center w-full max-w-7xl mb-6">
        <h1 className="text-4xl font-bold text-gray-800">{pose.title}</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-8 w-full max-w-7xl">
        ...
        {/* Pose Details and Instructions (Right Half) */}
        <div className="flex-1 bg-white p-6 rounded-xl shadow-lg">
          <Card className="shadow-none border-none">
            <CardHeader className="p-0 mb-4">
              <CardTitle className="text-xl font-bold text-gray-800">
                Instructions for {pose.title}
              </CardTitle>
            </CardHeader>
