...
const yogaPoses = [
  ...
  },
  {
    ...
    icon: (
      <span className="text-5xl" role="img" aria-label="Child">🧘‍♂️</span>
    ),
    isHighlighted: true,
  },
  {
    ...
    iconColor: 'bg-green-100',
    icon: (
      <span className="text-5xl" role="img" aria-label="Cobra">🐍</span>
    ),
  },
  {
    title: 'Mountain Pose',
    ...
    difficulty: 'Beginner',
    time: '1-2 minutes',
    description: 'Stand tall with feet hip-width apart, arms at your sides, and distribute your weight evenly.',
    benefits: ['Improves posture', 'Increases stability', 'Grounds the body'],
    iconColor: 'bg-blue-100',
    icon: (
      <span className="text-5xl" role="img" aria-label="Mountain">🏔️</span>
    ),
  },
  {
    title: 'Downward Dog',
    ...
    difficulty: 'Beginner',
    time: '1-3 minutes',
    description: 'From hands and knees, tuck toes under and lift hips up and back to form an inverted V-shape.',
  ...
  },
  {
    ...
    description: 'Step left foot back, turn it out 45 degrees. Bend right knee, and lift arms overhead.',
    benefits: ['Strengthens legs', 'Stretches groin', 'Builds focus'],
    iconColor: 'bg-blue-100',
    icon: (
      <span className="text-5xl" role="img" aria-label="Warrior">🤺</span>
    ),
  },
];
...
const YogaCard = ({ pose }) => {
  return (
    <div className={`flex-none bg-white rounded-3xl p-6 shadow-md border border-gray-100 transition-shadow duration-300 ${pose.isHighlighted ? 'shadow-xl' : ''}`}>
      <div className="flex flex-col h-full">
        {/* Icon */}
        <div className={`flex justify-center mb-4`}>
          <div className={`rounded-full p-4 ${pose.iconColor} w-20 h-20 flex items-center justify-center`}>
            {pose.icon}
          </div>
        </div>
        ...
        <div className="flex justify-center items-center space-x-4 text-sm mb-4">
          <div className={`rounded-full px-3 py-1 font-semibold ${
            pose.difficulty === 'Beginner' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'
          }`}>
            {pose.difficulty}
          </div>
        ...
        <div className="mt-auto pt-4 border-t border-gray-100">
          <button className="w-full text-blue-500 font-semibold py-3 rounded-full border border-blue-500 hover:bg-blue-50 transition-colors">
            Practice This Pose
          </button>
        </div>
      </div>
...
const YogaPage = () => {
  const categories = ['All Poses', 'Standing', 'Balance', 'Backbend', 'Inversion', 'Restorative'];
    ...
    <div className="bg-white mb-10">
      <div className="bg-gray-50 py-16 px-4 md:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Discover the ancient art of yoga with guided poses, breathing techniques, and mindfulness practices
        </p>
        <div className="flex justify-center items-center space-x-8 text-gray-600 mt-8">
          <div className="flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M14.752 11.168l-3.328-1.664A2 2 0 0010 11.237v1.526a2 2 0 001.424 1.833l3.328 1.664a2 2 0 002.576-1.833V12.986a2 2 0 00-2.576-1.833zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span>Guided Sessions</span>
          </div>
          <div className="flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v.01M12 8v.01M12 12v.01M12 16v.01M12 20v.01M12 16a9 9 0 01-9-9" />
            </svg>
            <span>All Levels</span>
          </div>
          <div className="flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 19V6c0-1.657 1.343-3 3-3s3 1.343 3 3v13M12 19V6a3 3 0 00-3-3m3 3a3 3 0 003 3v13" />
            </svg>
