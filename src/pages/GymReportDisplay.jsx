...
const GymReportDisplay = ({ reportData, onReset }) => {
            ...
            <Card className="border border-black/10 bg-white shadow-sm rounded-2xl">
                <CardHeader>
                    ...
                    <CardDescription className="text-sm text-gray-500">
                        Here is your performance summary from your strength training session.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    ...
                    {score !== null && (
                        <div>
                            ...
                            <Badge 
                                variant="default" 
                                className="text-lg px-4 py-2 font-semibold bg-blue-500 text-white"
                            >
                                {score} / 100
                            </Badge>
                        </div>
                    ...
                    {/* Additional Gym-specific metrics could go here */}
                    <div className="bg-gray-50 p-4 rounded-lg">
                        <h4 className="font-semibold text-gray-700 mb-2">💪 Keep Building Strength!</h4>
                        <p className="text-sm text-gray-600">
                            Consistency is key to muscle growth and strength gains. 
                            Keep track of your progress and gradually increase intensity.
                        </p>
                    </div>
                </CardContent>
            </Card>
...
export default GymReportDisplay;