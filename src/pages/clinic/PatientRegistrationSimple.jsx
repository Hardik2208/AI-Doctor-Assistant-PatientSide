...
import {
  User, Phone, MapPin, FileText, Camera, Save, ArrowLeft, 
  CheckCircle, Stethoscope, Heart, Activity, AlertCircle
} from 'lucide-react';

const PatientRegistrationSimple = () => {
...
export default PatientRegistrationSimple;